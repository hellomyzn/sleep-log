...
SHEET_NAME = CONFIG["GSS_SHEET_NAME"]["DAILY_SLEEP"]
PATH_KEYS = CONFIG["KEYS_DAILY_SLEEP"]["DAILY_SLEEP"]


@dataclass
class GssDailySleepRepository(GssBaseRepository):
    """gss daily sleep repository """
